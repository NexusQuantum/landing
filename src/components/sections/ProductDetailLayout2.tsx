...
const productDescriptions: { [key: string]: string } = {
  ...
  'Backup & Restore': 'NQRust-Backup & Restore modernizes enterprise backup and disaster recovery with immutable storage, rapid restore capabilities, and built-in ransomware protection. It ensures critical data remains safe, recoverable, and resilient against both system failures and malicious attacks.',
  'Kubernetes': 'NQRust-Kubernetes is a Rust-native Kubernetes distribution built for secure, high-performance container orchestration with memory-safe control plane components and enterprise-ready operations.',
...
const whitepaperMapping: { [key: string]: string } = {
  ...
  'HyperVisor': '[Nexus] NQRust-HV v2.0.pdf',
