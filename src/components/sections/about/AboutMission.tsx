  ...
  return (
    <div className={cn('bg-white flex flex-col items-center justify-center pt-[60px] pb-8 px-4 lg:pt-[100px] lg:pb-12 lg:px-[100px]', className)}>
      ...
      <div className="flex flex-col gap-8 lg:gap-12 items-center justify-end w-full max-w-[1128px]">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-[36px] items-start justify-between relative w-full max-w-[1128px]">
          {/* Left Content */}
          ...
          {/* Right Video */}
          <div className="h-[250px] lg:h-[495px] relative rounded-[20px] w-full lg:w-[495px] overflow-hidden bg-gray-100">
            <video 
              autoPlay 
              muted
